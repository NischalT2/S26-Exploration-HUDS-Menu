...
export default function Home() {
  return (
      <div className="bg-white min-h-screen">
        <div className="bg-red-500 w-full text-white flex justify-between items-center px-4 py-2">
          <span className = 'text-xl font-bold'>Harvard</span>
          <div className="bg-white w-7 h-7 flex flex-col justify-center items-center gap-1">
        ...
        <div className='flex flex-col w-10/11 min-h-screen mb-8 mx-auto mt-5 bg-red-700 rounded-2xl '>
        ...
        <button className='flex bg-white text-gray-700 text-xs px-4 py-2 rounded-full w-15 h-7 items-center justify-center cursor-pointer'>Daily</button>
